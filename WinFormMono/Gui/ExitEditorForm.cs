    ...
    public partial class ExitEditorForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (!automaticcheckBox.Checked)
            {
                ...
                editingExit.playerX = (short)(xPosUpDown.Value + pixelMapx);
                editingExit.playerY = (short)(yPosUpDown.Value + pixelMapy);
        ...
        private void xPosUpDown_ValueChanged(object sender, EventArgs e)
        {
            if (!settingValues)
            {
                ...
                editingExit.playerX = (short)xPosUpDown.Value;
                editingExit.playerY = (short)yPosUpDown.Value;
