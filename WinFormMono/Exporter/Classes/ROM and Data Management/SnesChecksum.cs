/*
 * Author:  Trovsky, ???? 
 * Comment: Adapted from SNES9x 1.53 memmap.cpp & memmap.h
 */
...
namespace ZScream_Exporter
{
    ...
    public static class SNESChecksum
    {
        ...
        private static EXTFMT ExtendedFormat = EXTFMT.NOPE;
        private static string
            ROMName,
            ROMId;
        private static byte[]
            ROM,
            RawROMName = new byte[ROM_NAME_LEN];
